...
| `convert_to_gen2` | Convert a `.das` file from gen1 (indentation-based) syntax to gen2 (braces/parentheses) using the `utils/gen1-to-gen2` converter. Optional `inplace` flag to modify the file directly |
